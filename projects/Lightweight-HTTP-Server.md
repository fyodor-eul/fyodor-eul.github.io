...
image: images/lightweight-http-server/http-server.png
description: A lightweight Web Server written in C
link: https://github.com/fyodor-eul/lightweight-http-server
